...
public class Simple extends PoliceMan {

    public Simple() {
    }

    public Simple(Long id, String name, String surname, String birth, String gender, boolean Hadtask, boolean detective, boolean trafficController, boolean simple, int Tasks) {
        super(id, name, surname, birth, gender, Hadtask, detective, trafficController, simple, Tasks);
    }
    
    @Override
    public String toString(){
        String result=" Officer of Police "; 
